...
const Logo = () => {
    return (
        <div className="logo">
            ...
            In order to start chatting with everyone, you must create an account and then log in (you will find those features on the top-right corner of the app, mid-top for mobiles).
            <br></br><br></br>
